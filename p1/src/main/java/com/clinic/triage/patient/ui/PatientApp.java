...
public class PatientApp extends JFrame {
    ...
    private JPanel buildRegistrationPanel() {
        ...
        registrationResultArea.setText("Nhập thông tin và chọn khoa muốn khám để nhận số thứ tự.");
    ...
    private JPanel buildDepartmentPanel() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Chọn khoa muốn khám"));
    ...
    private void lookupPrescription() {
        ...
        builder.append("Ngày kê: ").append(data.getCreatedAt()).append("\n\n");
    ...
    private void loadDepartments() {
        ...
        if (!departmentListModel.isEmpty()) {
